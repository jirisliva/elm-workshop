...
function _Browser_visibilityInfo()
{
	return (typeof _VirtualDom_doc.hidden !== 'undefined')
		? { as: 'hidden', z: 'visibilitychange' }
		:
	(typeof _VirtualDom_doc.mozHidden !== 'undefined')
		? { as: 'mozHidden', z: 'mozvisibilitychange' }
		:
	(typeof _VirtualDom_doc.msHidden !== 'undefined')
		? { as: 'msHidden', z: 'msvisibilitychange' }
		:
	(typeof _VirtualDom_doc.webkitHidden !== 'undefined')
		? { as: 'webkitHidden', z: 'webkitvisibilitychange' }
		: { as: 'hidden', z: 'visibilitychange' };
}
...
var author$project$Main$Model = F2(
	function (greetings, lastAccess) {
		return {U: greetings, I: lastAccess};
	});
...
var author$project$Main$init = function (_n0) {
	return _Utils_Tuple2(
		A2(author$project$Main$Model, 'Hello World', 'Unknown'),
		elm$core$Platform$Cmd$none);
};
var author$project$Main$OnLastAccess = function (a) {
	return {$: 2, a: a};
};
var elm$json$Json$Decode$string = _Json_decodeString;
var author$project$Main$onLastAccess = _Platform_incomingPort('onLastAccess', elm$json$Json$Decode$string);
var elm$core$Platform$Sub$batch = _Platform_batch;
var author$project$Main$subscriptions = function (_n0) {
	return elm$core$Platform$Sub$batch(
		_List_fromArray(
			[
				author$project$Main$onLastAccess(author$project$Main$OnLastAccess)
			]));
};
var elm$json$Json$Encode$string = _Json_wrap;
var author$project$Main$setProfile = _Platform_outgoingPort('setProfile', elm$json$Json$Encode$string);
	...
	function (msg, model) {
		switch (msg.$) {
			...
			case 1:
				return _Utils_Tuple2(
					model,
					author$project$Main$setProfile('pythagoras'));
			default:
				var lastAccess = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{I: lastAccess}),
...
var author$project$Main$SetProfile = {$: 1};
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								elm$html$Html$Events$onClick(author$project$Main$SetProfile)
							]),
						_List_fromArray(
							[
								elm$html$Html$text('Set Profile')
							])),
						A2(
						elm$html$Html$div,
						_List_Nil,
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										elm$html$Html$text('Last Access:')
									])),
								A2(
								elm$html$Html$em,
								_List_Nil,
