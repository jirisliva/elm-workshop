...
var author$project$Main$Model = F2(
	function (greetings, color) {
		return {color: color, greetings: greetings};
	});
...
var author$project$Main$init = function (flags) {
	return _Utils_Tuple2(
		A2(author$project$Main$Model, 'Ports: Store Application state in LocalStorage', flags.color),
		elm$core$Platform$Cmd$none);
};
var author$project$Main$OnColorChange = function (a) {
	return {$: 'OnColorChange', a: a};
};
var elm$json$Json$Decode$string = _Json_decodeString;
var author$project$Main$onColorChange = _Platform_incomingPort('onColorChange', elm$json$Json$Decode$string);
var author$project$Main$subscriptions = function (_n0) {
	return author$project$Main$onColorChange(author$project$Main$OnColorChange);
};
var elm$json$Json$Encode$string = _Json_wrap;
var author$project$Main$setColor = _Platform_outgoingPort('setColor', elm$json$Json$Encode$string);
	...
	function (msg, model) {
		switch (msg.$) {
			...
			case 'SetColor':
				...
				return _Utils_Tuple2(
					model,
					author$project$Main$setColor(color));
			default:
				var color = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
...
var author$project$Main$viewButton = F2(
	function (maybeCurrentColor, color) {
		var colorStyle = A2(
			elm$core$Maybe$withDefault,
			A2(elm$html$Html$Attributes$style, 'background', 'lightgrey'),
			A2(
				elm$core$Maybe$andThen,
				function (currentColor) {
					return _Utils_eq(currentColor, color) ? elm$core$Maybe$Just(
						A2(elm$html$Html$Attributes$style, 'background', color)) : elm$core$Maybe$Nothing;
				},
				maybeCurrentColor));
		return A2(
			...
			[
				...
				_List_fromArray(
					[
						...
						A2(author$project$Main$viewButton, model.color, 'Red'),
						A2(author$project$Main$viewButton, model.color, 'Blue'),
						A2(author$project$Main$viewButton, model.color, 'Green')
					]))
			]),
		title: 'Demo'
	};
		...
		A2(
			...
			elm$json$Json$Decode$oneOf(
				_List_fromArray(
					...
					])))))({"versions":{"elm":"0.19.0"},"types":{"message":"Main.Msg","aliases":{},"unions":{"Main.Msg":{"args":[],"tags":{"NoOp":[],"SetColor":["String.String"],"OnColorChange":["String.String"]}},"String.String":{"args":[],"tags":{"String":[]}}}}})}});}(this));