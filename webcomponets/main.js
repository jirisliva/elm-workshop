...
var author$project$Main$EditorChanged = function (a) {
	return {$: 'EditorChanged', a: a};
};
...
var author$project$Main$editorChangedDecoder = A2(
	elm$json$Json$Decode$map,
	author$project$Main$EditorChanged,
	A2(
			...
			[
				...
				_List_fromArray(
					[
						...
						'editorValue',
						elm$json$Json$Encode$string(model.greetings)),
						A2(elm$html$Html$Events$on, 'editorChanged', author$project$Main$editorChangedDecoder)
					]),
				_List_Nil)
			]),
		title: 'Demo'
...
_Platform_export({'Main':{'init':author$project$Main$main(
	elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.0"},"types":{"message":"Main.Msg","aliases":{},"unions":{"Main.Msg":{"args":[],"tags":{"NoOp":[],"EditorChanged":["String.String"]}},"String.String":{"args":[],"tags":{"String":[]}}}}})}});}(this));